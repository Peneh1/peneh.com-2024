...
<head>
    ...
    <title>Wheel Choice LLC</title>
    <meta name="author" content="Vecuro">
    <meta name="description" content="Wheel Choice LLC">
    <meta name="keywords" content="Wheel Choice LLC" />
  ...
  ============================== -->
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.php"><img src="assets/img/logo-mobile.png" alt="Wheel Choice"></a>
            </div>
            ...
            <div class="vs-mobile-menu">
                <ul>
                    ...
                    <li>
                        <a href="https://wheel-choice-llc-new.gogecko.com/">Customer Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header class="header-wrapper header-layout1 ">
                ...
                <div class="row justify-content-between">
                    <div class="col-9 col-lg-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.php"><img src="assets/img/logo.png" alt="Wheel Choice"></a>
                        </div>
                    </div>
                    <div class="col-3 col-lg-auto col-xxl-6 d-flex justify-content-end">
                    ...
                    <div class="col-xl-auto d-none d-xl-block  align-self-center ">
                        <div class="header-btn">
                            ...
                            <a href="https://wheel-choice-llc-new.gogecko.com/" class="vs-btn  ms-3 d-none d-xl-inline-block">Customer Login<i class="fa fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <!--  <div class="header-notice d-none d-md-block">
            <div class="container">
                <p class="mb-0 fs-xs text-title">Save up to 40% Hurry limited offer!</p>
            </div>
        </div>-->
    </header>