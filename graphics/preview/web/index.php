<!DOCTYPE html>
    <script>
		//if not in a iframe
	//	if (window==window.top) { window.location.href = "http://www.peneh.com"; }
...
<img class="preview-logo" src="https://peneh.com/assets/logo/vertical.svg"></img>
