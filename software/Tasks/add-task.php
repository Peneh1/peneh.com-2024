...
$sql = "INSERT INTO `tasks` (`created`, `title`, `notes`, `user_id`, `done`, `finished`) 
VALUES ( current_timestamp, '$title', '$notes', '$assign', '0', NULL)";
$added = $db->query($sql);
...
<select id="users" name="assignTo" required>
	<option value=""></option>
...
<script>
    var cars = document.getElementById("users")
