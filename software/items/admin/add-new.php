...
if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadfile)) {
				...
				$sql = "INSERT INTO items (item_id, title, discription, price, img_url)VALUES ('$item_id', '$title', '$discriptin', '$price', '$file_name')";
				$val = $db->query($sql);
						if($val){
...
<a href="../index.php">Home</a> <a href="edit.php">Edit</a>
<hr>
...
<textarea name="discrition" required></textarea><br>
	...
	<input type="number" step="0.01" name="price" required><br>
		<label for="file">Image <small>(max: 0.25mb)</small></label>
